package com.oga.photoeditor.pro.beauty.face.filters.effects.dialoge;
        ...
        if (id != R.id.text_view_later) {
            if (id != R.id.text_view_submit) {
                ...
                if (i >= 4) {
                    ...
                    SharedPreferenceManager.setRated(this.context, true);
                    dismiss();
                } else if (i > 0) {
                    Intent intent = new Intent("android.intent.action.SEND");
                    intent.setType("message/rfc822");
                    intent.putExtra("android.intent.extra.EMAIL", this.context.getResources().getString(R.string.rating_dialog_feedback_title));
