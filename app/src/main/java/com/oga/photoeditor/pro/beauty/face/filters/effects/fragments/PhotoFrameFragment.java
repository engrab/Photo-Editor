...
public class PhotoFrameFragment extends Fragment {
    ...
    private void saveImageIntoArray() {
        editImage = new ArrayList<>();
        editImage.add(R.drawable.edit1);
        editImage.add(R.drawable.edit2);
        editImage.add(R.drawable.edit3);
        editImage.add(R.drawable.edit4);
        editImage.add(R.drawable.edit5);
        editImage.add(R.drawable.edit6);
        editImage.add(R.drawable.edit1);
        editImage.add(R.drawable.edit2);
        editImage.add(R.drawable.edit3);
        editImage.add(R.drawable.edit4);
